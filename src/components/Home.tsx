...
const months = [
  {
    ...
    description: 'Зимняя сказка с снегом и лыжами в Караколе.\nТеплые юрты, замерзшие озера.\nТемпературы: -5°C до 3°C.'
  },
  {
    id: 2,
    name: 'Февраль',
    ...
    description: 'Сердце зимы: пушистый снег, горнолыжные курорты.\nУютные кафе с горячим чаем.\nТемпературы: -3°C до 5°C.'
  },
  {
    id: 3,
    name: 'Март',
    ...
    description: 'Весна пробуждается: первые цветы, праздник Навруз.\nПрогулки по природе.\nТемпературы: 5°C до 12°C.'
  },
  {
    id: 4,
    name: 'Апрель',
    ...
    description: 'Тепло и зелень: цветущие луга, полноводные реки.\nПервые походы.\nТемпературы: 10°C до 18°C.'
  },
  {
    id: 5,
    name: 'Май',
    ...
    description: 'Начало лета: сухая погода, трекинг и пикники.\nНомадские традиции.\nТемпературы: 15°C до 23°C.'
  },
  {
    id: 6,
    name: 'Июнь',
    ...
    description: 'Солнечное лето: пляжи Иссык-Куля, конные прогулки.\nФестивали.\nТемпературы: 20°C до 28°C.'
  },
  {
    id: 7,
    name: 'Июль',
    ...
    description: 'Пик сезона: юрты, спелые фрукты, трекинг в Тянь-Шане.\nТемпературы: 22°C до 30°C.'
  },
  {
    id: 8,
    name: 'Август',
    ...
    description: 'Золотая пора: походы к озерам, сбор урожая.\nФестивали.\nТемпературы: 20°C до 28°C.'
  },
  {
    id: 9,
    name: 'Сентябрь',
    ...
    description: 'Золотая осень: трекинг, осенние базары.\nМеньше туристов.\nТемпературы: 15°C до 25°C.'
  },
  {
    id: 10,
    name: 'Октябрь',
    ...
    description: 'Яркая осень: цветные листья, спокойные прогулки.\nТемпературы: 10°C до 18°C.'
  },
  {
    id: 11,
    name: 'Ноябрь',
    ...
    description: 'Переход к зиме: первые снега, городские экскурсии.\nТемпературы: 2°C до 10°C.'
  },
  {
    id: 12,
    name: 'Декабрь',
    ...
    description: 'Новогодняя магия: снег, фестивали, катание на коньках.\nТемпературы: -3°C до 5°C.'
  },
];
